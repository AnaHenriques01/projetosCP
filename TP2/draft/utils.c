...
void init(int K, int num_threads, float sum[K*2], int num_elems[K], float centroids[K*2]) {
...
int addToClosestCluster(int count, int K, int num_threads, int num_elems[K], float centroids[K*2], float sum[K*2]){
